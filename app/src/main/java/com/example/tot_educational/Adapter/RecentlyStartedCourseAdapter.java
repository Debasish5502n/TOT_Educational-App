...
public class RecentlyStartedCourseAdapter extends RecyclerView.Adapter<RecentlyStartedCourseAdapter.myViewHolder> {

    Context context;
    List<UpcomingCourseModel> models;

    public RecentlyStartedCourseAdapter(Context context, List<UpcomingCourseModel> models) {
    ...
    public void onBindViewHolder(@NonNull myViewHolder holder, int position) {
        ...
        map.put("courseUpdate", "Completed");
        Long currentTime = System.currentTimeMillis();

        if (models.get(position).getCourseEndDate() < currentTime) {
        ...
        Date res = new Date(models.get(position).getCourseEndDate());

        holder.courseDate.setText("Complete on- "+obj.format(res));
