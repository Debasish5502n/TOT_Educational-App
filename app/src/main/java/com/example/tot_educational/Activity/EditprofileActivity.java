...
import com.example.tot_educational.databinding.ActivityEditprofileBinding;
        ...
        database.getReference().child("users").child(FirebaseAuth.getInstance().getUid())
                .addListenerForSingleValueEvent(new ValueEventListener() {
                    ...
                    public void onDataChange(@NonNull DataSnapshot snapshot) {
                        ...
                        binding.email.setText(user2.getEmail());
                    }
        ...
        binding.continuebtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (selectedImage !=null){
                            ...
                            if (task.isSuccessful()){
                                reference.getDownloadUrl().addOnSuccessListener(new OnSuccessListener<Uri>() {
                                    ...
                                    public void onSuccess(Uri uri) {
                                        ...
                                        User user=new User(uid,name,phone,imageUri,email1,"");
                    ...
                    User user=new User(uid,name,phone,"No image",email1,"");
